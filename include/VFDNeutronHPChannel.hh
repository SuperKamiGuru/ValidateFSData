...
#ifndef VFDNeutronHPChannel_h
#define VFDNeutronHPChannel_h 1
#include "globals.hh"
...
// T.K.
  ...
  G4bool Register(VFDNeutronHPFinalState *theFS);
...
private:
  ...
  VFDNeutronHPFinalState ** theFinalStates; // also these are isotope-wise pionters, parallel to the above.
  G4bool * active;
  G4int niso;
