...
//
//
#ifndef VFDNeutronHP2NInelasticFS_h
#define VFDNeutronHP2NInelasticFS_h 1
...
class VFDNeutronHP2NInelasticFS : public VFDNeutronHPInelasticBaseFS
{
  ...
  VFDNeutronHP2NInelasticFS(){}
  ~VFDNeutronHP2NInelasticFS(){}
  void Init (G4double A, G4double Z, G4int M, G4String & dirName, G4String & aFSType);
  G4HadFinalState * ApplyYourself(const G4HadProjectile & theTrack);
  VFDNeutronHPFinalState * New()
  {
   VFDNeutronHP2NInelasticFS * theNew = new VFDNeutronHP2NInelasticFS;
   return theNew;
  }
