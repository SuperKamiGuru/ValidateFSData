...
#include "VFDNeutronHPFissionSpectrum.hh"
...
class VFDNeutronHPEnergyDistribution
{
  public:
  VFDNeutronHPEnergyDistribution()
  {
  ...
  inline void Init(std::istream & theData)
  {
	...
	case 5:
          ...
          break;
	case 7:
          theEnergyDistribution[i] = new VFDNeutronHPFissionSpectrum;
          break;
	case 9:
