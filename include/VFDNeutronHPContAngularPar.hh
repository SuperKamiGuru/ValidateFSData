...
//
#ifndef VFDNeutronHPContAngularPar_h
#define VFDNeutronHPContAngularPar_h 1
...
class VFDNeutronHPContAngularPar
{
  public:

  VFDNeutronHPContAngularPar()
  {
    theAngular = 0;
    currentMeanEnergy = -2;
     fresh = true;
  ...
  void Merge(G4double anEnergy, G4InterpolationScheme & aScheme,
             VFDNeutronHPContAngularPar & store1,
             VFDNeutronHPContAngularPar & store2) // hmmmm, this interpolates legendre coefficients. Dangerous @@@
  {
...
//             store2.theAngular[i].GetValue(ii)<<G4endl;
  ...
  G4double MeanEnergyOfThisInteraction()
  {
    ...
    {
      return 0;
      // throw G4HadronicException(__FILE__, __LINE__, "VFDNeutronHPContAngularPar: Logical error in Product class");
    }
    else
    {
