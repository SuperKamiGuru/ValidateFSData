...
//
//
#ifndef VFDNeutronHPEnAngCorrelation_h
#define VFDNeutronHPEnAngCorrelation_h 1
...
#include <fstream>
#include "globals.hh"
#include "VFDNeutronHPProduct.hh"
#include "G4ReactionProduct.hh"

class VFDNeutronHPEnAngCorrelation
{
  public:
  ...
  inline void Init(std::istream & aDataFile)
  {
    ...
    theProducts = new VFDNeutronHPProduct[nProducts];
  ...
  G4int nProducts;
  VFDNeutronHPProduct * theProducts;
  G4bool inCharge;
