...
//
//
#ifndef VFDNeutronHPFSFissionFS_h
#define VFDNeutronHPFSFissionFS_h 1
...
class VFDNeutronHPFSFissionFS : public VFDNeutronHPFinalState
{
  public:

  VFDNeutronHPFSFissionFS(){ hasXsec = false; }
  ~VFDNeutronHPFSFissionFS(){}
  ...
  {
   VFDNeutronHPFSFissionFS * theNew = new VFDNeutronHPFSFissionFS;
   return theNew;
  }
  ...
  VFDNeutronHPEnergyDistribution theDelayedNeutronEnDis;
