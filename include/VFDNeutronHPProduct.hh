...
//
//
#ifndef VFDNeutronHPProduct_h
#define VFDNeutronHPProduct_h 1
...
class VFDNeutronHPProduct
{
  ...
  inline void Init(std::istream & aDataFile)
  {
    ...
    if(theDistLaw==0)
    {
      ...
      theDist = new VFDNeutronHPIsotropic;
    }
    else if(theDistLaw == 1)
    {
      // Continuum energy-angular distribution
      theDist = new VFDNeutronHPContEnergyAngular;
    }
    ...
    {
      throw G4HadronicException(__FILE__, __LINE__, "distribution law unknown to VFDNeutronHPProduct");
    }
    if(theDist!=0)
    {
