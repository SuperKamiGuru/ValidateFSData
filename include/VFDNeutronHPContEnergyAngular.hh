...
//
#ifndef VFDNeutronHPContEnergyAngular_h
#define VFDNeutronHPContEnergyAngular_h 1
...
class VFDNeutronHPContEnergyAngular : public G4VNeutronHPEnergyAngular
{
  public:

  VFDNeutronHPContEnergyAngular()
  {
    theAngular = 0;
    currentMeanEnergy = -2;
  }
  ...
  void Init(std::istream & aDataFile)
  {
    ...
    theAngular = new VFDNeutronHPContAngularPar[nEnergy];
...
G4ReactionProduct * Sample(G4double anEnergy, G4double massCode, G4double mass);
  ...
  VFDNeutronHPContAngularPar * theAngular;
