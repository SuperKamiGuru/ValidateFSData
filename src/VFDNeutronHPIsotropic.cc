...
void VFDNeutronHPIsotropic::Init(std::istream & )
{
}

G4ReactionProduct * VFDNeutronHPIsotropic::Sample(G4double anEnergy, G4double massCode, G4double )
{
   ...
   else
   {
    ...
    return result;
    //result->SetDefinition( G4IonTable::GetIonTable()->GetIon ( Z ,  A , 0.0 ) );
     //throw G4HadronicException(__FILE__, __LINE__, "VFDNeutronHPIsotropic: Unknown ion case 2");
   }
