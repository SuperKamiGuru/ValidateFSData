...
G4HadFinalState * VFDNeutronHPNT2AInelasticFS::ApplyYourself(const G4HadProjectile & theTrack)
{
...
// fill the final state
  VFDNeutronHPInelasticBaseFS::BaseApply(theTrack, theDefs, 4);

// return the result
   return &theResult;
}

void VFDNeutronHPNT2AInelasticFS::
