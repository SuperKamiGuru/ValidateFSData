...
G4ReactionProduct * VFDNeutronHPEnAngCorrelation::SampleOne(G4double anEnergy)
{
...
G4ReactionProductVector * VFDNeutronHPEnAngCorrelation::Sample(G4double anEnergy)
{
  ...
  for(i=0; i<nProducts; i++)
  {
	...
	{
#ifdef G4_NHP_DEBUG
          cout <<"VFDNeutronHPEnAngCorrelation: "<<
	...
	{
          throw G4HadronicException(__FILE__, __LINE__, "VFDNeutronHPEnAngCorrelation::Sample: The frame of the finalstate is not specified");
	}
