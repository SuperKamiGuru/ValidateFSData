...
G4HadFinalState * VFDNeutronHPN2AInelasticFS::ApplyYourself(const G4HadProjectile & theTrack)
{
...
// fill the final state
  VFDNeutronHPInelasticBaseFS::BaseApply(theTrack, theDefs, 3);

// return the result
   return &theResult;
}

void VFDNeutronHPN2AInelasticFS::
