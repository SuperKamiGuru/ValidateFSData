...
G4HadFinalState * VFDNeutronHPNXInelasticFS::ApplyYourself(const G4HadProjectile & theTrack)
{
...
// fill the final state
  VFDNeutronHPInelasticBaseFS::BaseApply(theTrack, theDefs, 1);

// return the result
   return &theResult;
}

void VFDNeutronHPNXInelasticFS::
