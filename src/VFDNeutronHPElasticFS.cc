...
#include "G4NeutronHPDataUsed.hh"
  ...
  void VFDNeutronHPElasticFS::Init (G4double A, G4double Z, G4int M, G4String & dirName, G4String & )
  {
    G4String tString = "/FS";
    G4bool dbool;
...
//        consistency check
    ...
    else
    {
      ...
      throw G4HadronicException(__FILE__, __LINE__, "VFDNeutronHPElasticFS::Init -- unusable number for repFlag");
    }
    theData.close();
  }

  G4HadFinalState * VFDNeutronHPElasticFS::ApplyYourself(const G4HadProjectile & theTrack)
  {
//    G4cout << "VFDNeutronHPElasticFS::ApplyYourself+"<<G4endl;
    theResult.Clear();
...
//    G4cout << "VFDNeutronHPElasticFS::ApplyYourself++"<<eKinetic<<" "<<G4endl;
...
//080904 Add Protection for very low energy (1e-6eV) scattering
    ...
    else
    {
      ...
      throw G4HadronicException(__FILE__, __LINE__, "VFDNeutronHPElasticFS::ApplyYourSelf frameflag incorrect");
    }
    // now all in Lab
...
//    G4cout << "VFDNeutronHPElasticFS::ApplyYourself 10+"<<G4endl;
